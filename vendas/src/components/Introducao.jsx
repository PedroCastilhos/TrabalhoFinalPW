import './styles/styleIntroducao.css';

function Introducao() {
  return (
    <div className="container__introducao">
      <div className="text__introducao">
        <h1>Nossa História</h1>
        <p>
          Lorem ipsum dolor, sit amet consectetur adipisicing elit. Voluptates
          distinctio a eius quia pariatur, accusamus incidunt ad aspernatur, hic
          magni fugiat dignissimos. Similique, amet sapiente error voluptate
          voluptas nesciunt voluptatibus. Lorem ipsum dolor sit amet consectetur
      ...
      <div className="imgs">
        <img src="./banner.jpg" alt="Duas pessoas se comprimentando" />
        <img src="./banner2.jpg" alt="Plantas" />
      </div>
    </div>
  );
}
